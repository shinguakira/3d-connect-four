...
// Verifies the sessionStorage-driven reconnect path: after a tab reload, the
// client should silently rejoin its previous online session (room +
// playerId) without bouncing the user back to the title menu.
