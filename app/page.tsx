...
const GAME_MODES = [
  { id: "two-player" as GameMode, name: "2プレイヤー", description: "友達と対戦", available: true },
  { id: "vs-ai" as GameMode, name: "vs AI", description: "コンピューター対戦", available: true },
  { id: "online" as GameMode, name: "オンライン", description: "オンライン対戦", available: true },
]
...
export default function Component() {
  ...
  const handleQuickMatch = useCallback(async (playerName: string) => {
    setOnlineLoading(true)
    setOnlineError(null)
    ...
    try {
      ...
      if (result.success) {
        setOnlineRoomId(result.room.id)
        setOnlinePlayerId(result.playerId)
        setGameState("online-waiting")
      } else {
